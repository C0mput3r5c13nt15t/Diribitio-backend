...
class StudentProjectDeleted extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Es tut uns leid dir mitteilen zu müssen, dass dein Projekt gelöscht wurde. Für nähere Informationen, warum das Projekt gelöscht wurde, wenden dich sich bitte an den zuständigen Admin.')
